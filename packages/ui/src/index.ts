// @smartgrid/ui — shadcn/Radix primitives; theme tokens from @smartgrid/design-system/css
// Origin: stern-bak packages/react-core/ui/src/index.ts.
...
export type { Theme, ThemeContextValue, ThemeProviderProps } from './providers/ThemeProvider.js';
...
// (a multi-MB peer) which every consumer of @smartgrid/ui would otherwise
// inherit. Import directly from `@smartgrid/ui/chart` when needed.
