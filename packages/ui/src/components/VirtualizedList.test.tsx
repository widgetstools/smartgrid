...
import { measureItemHeight, useVirtualScroll, VirtualizedList } from './VirtualizedList.js';

afterEach(cleanup);

function renderList<T>(overrides: Partial<React.ComponentProps<typeof VirtualizedList<T>>> = {}) {
...
describe('measureItemHeight', () => {
  ...
  it('reads height from getBoundingClientRect', () => {
    ...
    element.getBoundingClientRect = () => ({ height: 48 }) as DOMRect;
