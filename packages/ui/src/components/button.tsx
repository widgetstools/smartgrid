...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md font-semibold tracking-tight transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring disabled:opacity-50',
  {
    variants: {
      variant: {
      ...
      size: {
        default: 'h-control px-[14px] gap-1.5 text-md',
        sm: 'h-control-sm rounded-md px-(--sg-control-px) gap-1 text-sm',
        lg: 'h-control-lg rounded-md px-[18px] gap-2 text-lg',
