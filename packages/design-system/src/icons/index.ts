/**
 * @smartgrid/design-system/icons
 *
 * Framework-agnostic capital-markets icon library. All icons live in
 * `svg/` (shipped with the package under `./icons/svg/*`) and are also
 * bundled as strings in `./allIcons` (generated by scripts/generate-icons.mjs).
 * Most icons use `currentColor` so they inherit CSS colour.
 *
 * Origin: stern-bak packages/design-system/icons-svg/index.ts (Angular
 * bindings dropped; React binding lives in `@smartgrid/design-system/react`).
 *
 * ─── Usage ───────────────────────────────────────────────────
 *
 *   // SVG string (inline, currentColor)
 *   import { icons, bondSvg } from '@smartgrid/design-system/icons';
 *
 *   // React
 *   import { DynamicIcon } from '@smartgrid/design-system/react';
 *   <DynamicIcon icon="mkt:bond" style={{ width: 16 }} />
 *
 *   // Bundler asset import
 *   import bondUrl from '@smartgrid/design-system/icons/svg/bond.svg';
 *
 * ─── Sizing ──────────────────────────────────────────────────
