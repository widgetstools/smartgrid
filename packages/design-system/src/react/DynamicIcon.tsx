 ...
 * Origin: stern-bak packages/design-system/icons-svg/react/DynamicIcon.tsx.
 *
...
import { MARKET_ICON_SVGS } from '../icons/allIcons';
...
export function DynamicIcon({ icon, style, className }: DynamicIconProps) {
  ...
  //    Render as inline SVG from @smartgrid/design-system/icons strings
  if (prefix === 'mkt') {
