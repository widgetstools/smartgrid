// ─────────────────────────────────────────────────────────────
//  SmartGrid design system — Primitive Tokens
//  Origin: stern-bak packages/design-system/src/tokens/primitives.ts (StarUI).
...
export const colors = {
  ...
  // ── Brand / signature cyan (--sg-primary) ──
  brand: {
    light: '#0891b2',
    lightHov: '#0e7490',
    lightLo: '#0e7490',
  ...
  // ── Info (signature cyan — same hue family as brand) ──
  cyan: {
    light: '#0891b2',
    lightHov: '#0e7490',
    dark: '#22d3ee',
