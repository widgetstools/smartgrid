...
import { dark, light, type ColorScheme } from './semantic';
...
const requiredTradeKeys = ['flat', 'positiveStrip', 'negativeStrip', 'bidFill', 'askFill'] as const;
...
describe('ColorScheme contract', () => {
  ...
  it('Signature cyan: primary and info share the accent hue', () => {
