// ─────────────────────────────────────────────────────────────
//  SmartGrid design system — Component Tokens
//  Origin: stern-bak packages/design-system/src/tokens/components.ts.
//  Per-component overrides that shadcn components consume.
...
export function componentTokens(scheme: ColorScheme) {
  return {
    ...
    button: {
      ...
      // the @smartgrid/ui button variants — keep in sync.
      height: {
        sm: '28px',
        default: '34px',
        lg: '40px',
