// ─────────────────────────────────────────────────────────────
//  SmartGrid design system — Control Density Tokens
//  Origin: stern-bak packages/design-system/src/tokens/controls.ts.
...
//  with `controls.sm.height` (TS) or `var(--sg-control-sm-height)`
//  (inline-style CSS).
//
